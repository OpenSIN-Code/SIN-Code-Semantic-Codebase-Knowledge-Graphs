...
- **Small, composable units:** each module should be usable on its own and via
  the `sckg` CLI / MCP server.

## Reporting issues

Open an issue at
https://github.com/OpenSIN-Code/SIN-Code-Semantic-Codebase-Knowledge-Graphs/issues with a minimal reproduction.
